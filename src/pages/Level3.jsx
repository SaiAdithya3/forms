...
const Level3 = ({ onSubmit }) => {
  ...
  return (
    <div className="flex justify-center items-center flex-col gap-14 py-20 overflow-auto ">
      <h1 className='text-3xl w-full px-40 text-center font-semibold'>Survey Form with Dependent Questions and Dynamic Sections</h1>
